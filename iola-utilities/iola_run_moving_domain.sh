...
export FCST_LENGTH=84   
export EXPT=monsoon_dep
...
export OUTPUT_FREQ_INTER=180
export OUTPUT_FREQ_FINER=60
export TIME_STEP=30
...
Clat=(21) 
Clon=(89)
d2_lat_dia=(12.0 12.0 12.0 12.0 6.0)
d2_lon_dia=(12.0 12.0 12.0 12.0 6.0)
d3_lat_dia=(6.0 6.0 6.0 6.0 4.0)
d3_lon_dia=(6.0 6.0 6.0 6.0 4.0)

long_conv=0.5  # Longitude conversion factor
res_d1=0.135
MOAD_lat_size=40.0  # along lat D01 size
MOAD_lon_size=50.0  # along lon D01 size
grid_ratio=3
Slat=0      ### D01 starting lat
Slon=55        ## D01 starting lon
export REF_LAT=20.0
export REF_LON=80.0
...
&domains
  ...
  j_parent_start = 1, $(IFS=,; echo "${namelist_jsrt[*]}" | sed 's/,/, /g'),
  feedback = 1,
  num_moves = 0, -99, -99, 0, 0, 0, 0, 0, 0, 0, 0,
...
/
 ...
 &physics
  ...
  co2tf = 1,
  vortex_tracker = 2, 2, 7, 2, 2, 2, 2, 2, 2
